...
package org.apache.flink.streaming.ml.pipeline
...
/** Transformer trait for Flink's streaming pipeline operators.
  *
  * A Transformer transforms a [[DataStream]] of an input type into a [[DataStream]] of an output type.
...
trait Transformer[Self <: Transformer[Self]]
  ...
  /** Transform operation which transforms an input [[DataStream]] of type I into an output [[DataStream]]
    * of type O. The actual transform operation is implemented within the
    * [[TransformDataSetOperation]].
    *
    * @param input Input [[DataStream]] of type I
